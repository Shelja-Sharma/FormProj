...
const DashBoard = ({ navigation }) => {
    ...
    const onlycheck = useSelector(state => state.dataRedu.allData)
    console.log("in DASHBOARD")

    const [checkData, setCheckdata] = useState(data)
    // const onlycheck = data
    ...
    const decrementMethod = (itemIndex) => {
        ...
        data.map((item, index) => {
            // console.log("decrement method index is",item.id)
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
                    {/* {
                        selector.find((items, idx) => {
                            ...
                            : */}
                    <Text style={styles.priceStyle}>${item.updatePrice}</Text>
                    {/* } */}
                            ...
                            <View style={[styles.addToCartStyle, { flexDirection: 'row', justifyContent: 'space-evenly' }]}>
                                ...
                                {/* {
                                    ...
                                    count_Val.map((items, id) => {
                                        if (items.id == item.id) {
                                            return ( */}
                                <Text style={{ fontSize: responsiveFontSize(2), color: 'black' }}>{item.count}</Text>
                                {/* )
                                        }
                                    })
                                } */}
    ...
    const renderHeaderMethod = () => {
        return (
            <View style={styles.headerAreaStyle}>
                ...
                <View style={{ borderWidth: 0.5, height: responsiveHeight(5), borderColor: 'lightcoral', marginLeft: responsiveWidth(2) }} />
    ...
    const closeModalMethod = (value) => {
        console.log("value is check box",value)
    ...
    const closeSortModal = (value) => {
        ...
        // if (value == '') {
        //     console.log("inside the if and data is",data)
        //     setCheckdata(data)
        // }
        // else {
            let SortedData;
            ...
            if (value == "Star") {
                ...
                SortedData = array.sort((a, b) => {
                    return a.updatePrice - b.updatePrice;
                });
            }
            else if (value == "HighToLow") {
                SortedData = array.sort((a, b) => {
                    return b.updatePrice - a.updatePrice;
                });
            }
            else if (value == 'default')
            {
                return (setCheckdata(data),
    ...
    return (
        <>
            <View style={styles.headingAreaStyle}>
                ...
                <TouchableOpacity onPress={() => navigation.toggleDrawer()} style={{ position: 'absolute', left: responsiveHeight(1), top: responsiveHeight(2) }}>
